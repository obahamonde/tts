...
from typing import Literal, TypeAlias, TypeVar, ParamSpec,Callable, Awaitable
import aiofiles
...
def create_app():
	...
	@app.get("/generate")
	async def _(text: str, lang: Lang, gender: Gender = "female"):
		return StreamingResponse(
			await generate_audio(text, lang, f"/app/samples/{gender}_{lang}.wav"),
